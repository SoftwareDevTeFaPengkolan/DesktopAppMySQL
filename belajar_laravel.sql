...
--
-- Host: localhost:3306
-- Generation Time: Oct 02, 2024 at 06:37 PM
...
(1, 'Zainudin', 'Manager', 43, 'Jl. Asmara 1'),
(2, 'slamet', 'programer', 29, 'griya family 3');
...
--
ALTER TABLE `pegawai`
  MODIFY `pegawai_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
